...
inline double hFil_forward_simd(int t, int i, int j)
{
    return HPHY(t - 1, i, j) +
	alpha * (HFIL(t - 1, i, j) - 2 * HPHY(t - 1, i, j) + HPHY(t, i, j));
}
...
inline double uFil_forward_simd(int t, int i, int j)
{
    return UPHY(t - 1, i, j) +
	alpha * (UFIL(t - 1, i, j) - 2 * UPHY(t - 1, i, j) + UPHY(t, i, j));
}
...
inline double vFil_forward_simd(int t, int i, int j)
{
    return VPHY(t - 1, i, j) +
	alpha * (VFIL(t - 1, i, j) - 2 * VPHY(t - 1, i, j) + VPHY(t, i, j));
}
...
inline double hPhy_forward_simd(int t, int i, int j)
{
    double c, d;
...
inline double uPhy_forward_simd(int t, int i, int j)
{
    double b, e, f, g;
...
inline double vPhy_forward_simd(int t, int i, int j)
{
    double c, d, e, f;
